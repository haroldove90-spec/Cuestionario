...
export const FormTitleBanner: React.FC<FormTitleBannerProps> = ({
  data,
  onChangeClientInfo,
  onLoadSample,
  onClear,
  ...
  return (
    <div className="bg-white border-b border-slate-200 shadow-2xs py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        {/* Client instruction callout banner */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-2">
          <div>
            ...
            <input
              ...
              className="w-full text-xs px-3 py-2 bg-white border border-slate-200 rounded-xl focus:border-blue-500 outline-none transition-colors shadow-2xs text-slate-700 font-medium"
            />
          </div>
          <div>
